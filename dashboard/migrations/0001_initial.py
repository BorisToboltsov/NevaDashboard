# Generated by Django 3.2 on 2022-04-15 13:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_group', models.CharField(blank=True, max_length=255, null=True, verbose_name='Школьная группа')),
                ('paid_status', models.CharField(blank=True, max_length=50, null=True, verbose_name='Статус оплаты')),
