# Generated by Django 3.2 on 2022-05-11 10:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('manager_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='authapp.employee', verbose_name='Менеджер')),
            ],
            options={
                'verbose_name': 'Группа',
