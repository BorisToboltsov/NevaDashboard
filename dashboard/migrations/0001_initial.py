    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('manager_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='dashboard.employeedata', verbose_name='Менеджер')),
            ],
            options={
                'verbose_name': 'Группа',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='dashboard.registrysendingtravelagency', verbose_name='Агенство по отправке'),
        ),
        migrations.AddField(
