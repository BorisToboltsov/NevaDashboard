...
from .models import CatalogName, CatalogData, Contact, RegistrySendingTravelAgency, RegistryTransportOrganizations, RegistryFoodOrganizations, RegistryHotels, RegistryMuseum, EmployeeData, Group, GroupMuseum, GroupHotel, GroupTransport, GroupFood
